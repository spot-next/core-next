...
public abstract class Item implements Serializable {
    ...
    /**
     * If this object is used as a proxy, eg. in a collection or relation, this is true. The item property handler then
     * knows it has to load it on the fly.
     */
    ...
    /**
     * @return true if the item has a PK. It is assumed that it has been saved before. If you set a PK manually and save
     * the item, an existing item with the same PK will be overwritten.
     */
    ...
    /**
     * Returns a hash code calculated of all properties that are defined as unique (with the {@link Property}
     * annotation).
     *
     * @return
     */
