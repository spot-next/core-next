...
/**
 * This mixin serves as a start point for an embedded jetty server to boot a {@link ModuleInit} class.
 */
public class EmbeddedJettyServer<I extends WebModuleInit> {
    ...
    protected ClassLoader getClassLoader(WebAppContext context) throws IOException {
        ...
        ClassLoader cassLoader = null;

        try {
            cassLoader = AccessController.doPrivileged(new PrivilegedExceptionAction<ClassLoader>() {
                @Override
