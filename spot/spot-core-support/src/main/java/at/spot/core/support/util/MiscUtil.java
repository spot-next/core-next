...
public class MiscUtil {
    ...
    /**
     * Calls close() on all given objects that implement the {@link Closeable} interface. Doesn't throw any exceptions
     * at all.
     *
...
//                LOG.log(Level.WARN, String.format("An error occured while closing %s", e.get));
            }
        }
    }
