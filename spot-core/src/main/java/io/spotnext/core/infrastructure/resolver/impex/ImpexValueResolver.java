...
public interface ImpexValueResolver {
	 ...
	 * @param columnDefinition a {@link io.spotnext.core.infrastructure.support.impex.ColumnDefinition} object.
	 * @return a T object.
	 * @throws io.spotnext.core.infrastructure.exception.ValueResolverException if any.
	 */
